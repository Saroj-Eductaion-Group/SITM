    ...
    undergraduate: [
      {
        ...
        courses: [
          ...
          { name: 'Biotechnology', duration: '4 Years', seats: 120 },
          { name: 'Bio-Medical Engineering', duration: '4 Years', seats: 60 },
          { name: 'Electrical Engineering', duration: '4 Years', seats: 60 },
          { name: 'Agricultural Engineering', duration: '4 Years', seats: 60 },
          { name: 'Civil Engineering', duration: '4 Years', seats: 180 },
          { name: 'Environmental Engineering', duration: '4 Years', seats: 30 }
        ]
      },
      {
        title: 'B.Pharma',
        courses: [
          { name: 'B.Pharma', duration: '4 Years', seats: 100 },
        ],
      },
    ],
    postgraduate: [
      ...
      },
      {
        title: 'M.Tech',
        courses: [
          { name: 'Power Electronics', duration: '2 Years', seats: 18 },
          { name: 'Electronics & Communication', duration: '2 Years', seats: 18 },
          { name: 'Thermal Science', duration: '2 Years', seats: 18 },
          { name: 'Computer Science', duration: '2 Years', seats: 18 },
          { name: 'Information Technology', duration: '2 Years', seats: 18 }
        ]
      },
    ...
    diploma : [
      {
        ...
        courses: [
          { name: 'Civil Engineering', duration: '3 Years', seats: 60 },
          { name: 'Mechanical Engineering', duration: '3 Years', seats: 60 },
          { name: 'Electrical Engineering', duration: '3 Years', seats: 60 },
          { name: 'Electronics and Communication Engineering', duration: '3 Years', seats: 60 }
        ]
      },
  ...
  return (
    <div className="max-w-7xl py-24 mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-16 text-center bg-gray-50 rounded-lg p-6">
        ...
        <button onClick={handleContactUs}  className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          Contact Us
        </button>
      </div>
    </div>
