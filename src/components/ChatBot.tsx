...
const Chatbot = () => {
  ...
  const toggleChatbot = () => {
    setIsOpen(!isOpen);
    if (!isOpen) setShowContactForm(false);
  };
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => generateBotResponse(inputValue), 800);
  };
  ...
  const handleOptionSelect = (option: string) => {
    ...
    if (option === "Contact administration") {
      ...
      setTimeout(() => generateBotResponse(option), 500);
    }
  };
...
Eligibility: 10+2 with Physics, Chemistry, and Mathematics`;
    } else if (input.includes("diploma")) {
...
Eligibility: 10th pass with Science and Mathematics`;
    } else if (input.includes("polytechnic")) {
...
Duration: 6 months to 2 years`;
      ...
      response =
        "I'm here to assist you with any queries about our engineering and polytechnic programs.";
      options = [
        "Academic programs information",
        "Admission process",
        "Campus facilities",
